...
export const api_v1_companytext_listFailed = (error, starter) => ({
...
export const api_v1_companytext_createFailed = (error, starter) => ({
...
export const api_v1_companytext_readFailed = (error, starter) => ({
...
export const api_v1_companytext_updateFailed = (error, starter) => ({
...
export const api_v1_companytext_partial_updateFailed = (error, starter) => ({
...
export const api_v1_companytext_deleteFailed = (error, starter) => ({
