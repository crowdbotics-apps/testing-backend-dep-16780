...
export const api_v1_companytext_list = () => ({
  type: types.API_V1_COMPANYTEXT_LIST
})
export const api_v1_companytext_listSucceeded = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_listFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_LIST_FAILED,
  response,
  starter
})
export const api_v1_companytext_create = data => ({
  type: types.API_V1_COMPANYTEXT_CREATE,
  data
})
export const api_v1_companytext_createSucceeded = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_createFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_CREATE_FAILED,
  response,
  starter
})
export const api_v1_companytext_read = () => ({
  type: types.API_V1_COMPANYTEXT_READ
})
export const api_v1_companytext_readSucceeded = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_readFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_READ_FAILED,
  response,
  starter
})
export const api_v1_companytext_update = data => ({
  type: types.API_V1_COMPANYTEXT_UPDATE,
  data
})
export const api_v1_companytext_updateSucceeded = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_updateFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_UPDATE_FAILED,
  response,
  starter
})
export const api_v1_companytext_partial_update = data => ({
  type: types.API_V1_COMPANYTEXT_PARTIAL_UPDATE,
  data
})
export const api_v1_companytext_partial_updateSucceeded = (
  response,
  starter
) => ({
  type: types.API_V1_COMPANYTEXT_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_partial_updateFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_PARTIAL_UPDATE_FAILED,
  response,
  starter
})
export const api_v1_companytext_delete = () => ({
  type: types.API_V1_COMPANYTEXT_DELETE
})
export const api_v1_companytext_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_companytext_deleteFailed = (response, starter) => ({
  type: types.API_V1_COMPANYTEXT_DELETE_FAILED,
  response,
  starter
})
